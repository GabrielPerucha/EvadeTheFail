...
public class Cartas {
	...
	public Carta ofensa = new Carta(id++, "Ofensa", "Ataca con fiereza al rival\nDano: " + Combate.formulaDano(jugador, enemigo) + 1, "Neutro", 1, "Neutro", new EfectoSobreEstadisticas[]{new Dano(Combate.formulaDano(jugador, enemigo), 1, false, 0)});
	...
	public Carta defensa = new Carta(id++, "Defensa", "Defiende la fiereza del rival\nBloqueo: " + jugador.getDefensa()/5 + 2, "Neutro", 1, "Neutro", new EfectoSobreEstadisticas[]{new Bloqueo(1, (jugador.getDefensa()/5 + 2), 1, true, 0)});
