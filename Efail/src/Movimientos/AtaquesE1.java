...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
	...
	public Ataque endurecerRB = new Ataque("La blanda bola de gelatina trata de aumentar su defensa endureciendose, pero reduce su movilidad"
			...
			new Efecto[]{new EfectoSobreEstadisticas("defensa", 1.33, 0, 1, 0, true), new EfectoSobreEstadisticas("ataque", 0.85, 0, 1, 0, true)});
	...
	public Ataque endurecerRA = new Ataque("La blanda bola de gelatina trata de aumentar su defensa endureciendose, pero reduce su movilidad"
			...
			new Efecto[]{new EfectoSobreEstadisticas("defensa", 1.5, 0, 1, 0, true), new EfectoSobreEstadisticas("ataque", 0.85, 0, 1, 0, true)});
	...
	public Ataque espadazoRB = new Ataque("Extrañamente una criatura fantastica utiliza mejor la espada que muchas personas reales.\n"
			...
			new Efecto[] {new EfectoSobreEstadisticas("probCritico", 1.15, 0, 1, 0, true), new EfectoSobreEstadisticas("danoCritico", 1.2, 0, 1, 0, true), new EfectoSobreEstadisticas("dano", 1, 0, 1, 0, false)});
	...
	public Ataque espadazoRA = new Ataque("Duende de los criticos (ahora es personal).\n"
			...
			new Efecto[] {new EfectoSobreEstadisticas("probCritico", 1.25, 0, 1, 0, true), new EfectoSobreEstadisticas("danoCritico", 1.3, 0, 1, 0, true), new EfectoSobreEstadisticas("dano", 1, 0, 1, 0, false)});
